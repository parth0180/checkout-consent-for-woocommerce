...
class WCCA_PDF_Generator
{
    ...
    /**
     * Get the public URL for a generated PDF path.
     */
    public static function path_to_url(string $filepath): string
    {
        $upload = wp_upload_dir();
        return str_replace(
     ...
     * @return string|false
     */
    private static function build_pdf(
        object $sig,
        WC_Order $order,
        int $sig_id
    ): string|false {
        ...
        $move_y = function (int $delta) use (&$y): void {
            $y += $delta; };
